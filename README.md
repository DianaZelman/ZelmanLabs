...
CarShop - учебный веб-проект, разработанный в рамках курса по веб-технологиям. Представляет собой интернет-магазин автомобилей с админ-панелью, корзиной заказов и системой логирования.
